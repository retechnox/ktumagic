    ...
    <div class="container footer-grid">
        <div class="footer-brand">
            ...
            <div class="social-links">
                <a href="https://chat.whatsapp.com/LP2seQqrDoC5NX1OErAbSO?mode=gi_t" class="social-icon si-whatsapp"
                    aria-label="WhatsApp">
                ...
                <a href="https://t.me/ktumagic" class="social-icon si-telegram" aria-label="Telegram">
                ...
                <a href="https://www.instagram.com/ktumagic" class="social-icon si-instagram" aria-label="Instagram">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        <path
                ...
                <a href="https://www.youtube.com/@ktumagic" class="social-icon si-linkedin" aria-label="YouTube">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        <path

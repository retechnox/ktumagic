...
<div id="socialModal" class="modal-backdrop">
  <div class="modal-card">
    ...
    <div class="social-grid">
      ...
      <a href="<?= $contact['whatsapp_2024'] ?? 'https://chat.whatsapp.com/Lk4IJeebv8s6xIpqg2cT1H' ?>" target="_blank" class="social" style="background: #25D366;">
        <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href="<?= $contact['youtube'] ?? 'https://youtube.com/@ktumagic' ?>" target="_blank" class="social" style="background: #FF0000;">
        <svg viewBox="0 0 24 24" fill="currentColor">
